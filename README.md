...
HTML5: Estruturação semântica. CSS3: Estilização, Flexbox, Grid Layout e Animações. JavaScript (ES6+): Manipulação de DOM, Eventos e Fetch API. Git/GitHub: Versionamento de código.
